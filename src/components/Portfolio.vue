<template>
  ...
  <div class="portfolio-container">
    ...
    <div class="row row-cols-3">
      ...
      <div class="col">
        <div class="portfolio-job" id="giasite" @click="toggle('g')">
          <div class="grayscale">
            <div class="details">
              <p>CodeIgniter</p>
              <p>Company</p>
      ...
      <div class="col">
        <div class="portfolio-job" id="mairyrizou" @click="toggle">
          <div class="grayscale">
            <div class="details">
              <p>Wordpress</p>
              <p>Personal</p>
      ...
      <div class="col">
        <div class="portfolio-job" id="triantafylli" @click="toggle">
          <div class="grayscale">
            <div class="details">
              <p>Wordpress</p>
              <p>Personal</p>
      ...
      <div class="col">
        <div class="portfolio-job" id="julius" @click="toggle">
          <div class="grayscale">
            <div class="details">
              <p>Wordpress</p>
              <p>Company</p>
      ...
      <div v-if="modalOpen" class="portfolio-modal" @click.self="close()">
        <div class="portfolio-body">
          <div class="portfolio-image">
            ...
            <a class="btn btn-info portfolio-link" href="https://www.google.gr" target="_blank"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-link" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
#correct {
  width: 300px;
  height: 300px;
  background: url("../assets/images/correct.jpg");
  background-size: 100%;
...
#giasite {
  width: 300px;
  height: 300px;
  background: url("../assets/images/giasite.jpg");
  background-size: 100%;
  background-position-x: center;
}
...
#mairyrizou {
  width: 300px;
  height: 300px;
  background: url("../assets/images/mairyrizou.jpg");
  background-size: 100%;
  background-position-x: center;
}
...
#triantafylli {
  width: 300px;
  height: 300px;
  background: url("../assets/images/triantafylli.jpg");
  background-size: 100%;
  background-position-x: center;
}
...
#julius {
  width: 300px;
  height: 300px;
  background: url("../assets/images/julius.png");
  background-size: 100%;
  background-position-x: center;
}
